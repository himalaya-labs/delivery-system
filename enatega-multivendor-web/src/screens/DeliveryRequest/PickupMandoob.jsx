...
const PickupMandoob = () => {
  ...
  const { state, setAddressFrom } = useRequestDelivery();
  ...
  console.log({ state });
  const allDetails = localStorage.getItem("addressFrom");
  ...
  const handleNext = () => {
    ...
    navigate("/otlob-mandoob/dropoff");
  };
