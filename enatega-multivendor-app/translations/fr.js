export const fr = {
  ...
  welcome:
    "Bienvenue chez Orderat, parfois tout ce dont vous avez besoin, c'est de l'amour. Mais un peu de nourriture de temps en temps ne fait pas de mal.",
  welcomeScreen: 'Bienvenue chez Orderat',
  ...
  createAccount: 'Créez votre compte Orderat',
  ...
  enategaUseYourLocationMessage:
    'Orderat utilise votre emplacement pour afficher les restaurants à proximité de chez vous !',
