export const en = {
  ...
  welcome:
    "Welcome to Orderat! sometimes all you need is love. But a little food now and then doesn't hurt.",
  welcomeScreen: 'Welcome to Orderat',
  loginBtn: 'Login',
  ...
  fullDeliveryAddress: 'Enter your full delivery address',
  ...
  deliveryLocation:
    'Enable your location so we can show you endless options around you!',
  locationBtn: 'Enable Location.',
  ...
  deliveredOrder: 'Your order has been delivered.',
  ...
  otpForResetPassword: 'An OTP to reset password has been sent to your email.',
  ...
  noRestaurant: 'No restaurant currently offers delivery in your area yet.',
  apply: 'Apply',
  filters: 'Filters',
  help: 'Help',
  ...
  faq5Description:
    'Yes, you can cancel your order once it is placed. However, once the order has been prepared, you can no longer cancel the order. You may contact the restaurant directly for assistance.',
  ...
  restaurantClosed: 'The restaurant is closed at the moment.',
  backToRestaurants: 'Go back to restaurants',
  seeMenu: 'See Menu',
  askContactlessDelivery: 'Request contactless delivery!',
  ...
  noGrocery: 'No grocery shop currently offers delivery in your area yet',
  ...
  search_place: 'Search for a place or select it on the map',
  ...
  better_place_description: 'Better place description: eg. Building 3, level 2',
